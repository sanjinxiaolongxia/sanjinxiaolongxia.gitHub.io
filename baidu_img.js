	...
	*/
	...
	const webSrc=`
		<div id="hbWarp" style="position: fixed;inset: 0;background-color: #00000050;display: flex;flex-direction: column;row-gap: 10px;justify-content: center;align-items: center;">
		  <div class="img" style=" width: 80%; max-width: 360px;"><a href="#" rel="nofollow"><img src="https://www.2898.com/ueditor/php/upload/image/20240123/1706025433289429.png" width="100%"/></a></div>
